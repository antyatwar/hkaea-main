<div>
    <x-app.hero>
        <img src="{{ asset('/images/hero-performance.jpg') }}" alt="{{ __(config('app.fullname')) }}" class="w-full" />

        <div class="absolute inset-0 left-4 top-4 hidden md:block">
            <div class="inline-grid gap-2">
                <a href="#performance" class="inline-flex items-center gap-1 bg-white text-red-800 border-2 border-red-800 px-10 py-2 rounded-full group hover:bg-red-800">
                    ...
                    <span class="group-hover:text-white">{{ __('Performance') }}</span>
                </a>
                <a href="#performance-photos" class="inline-flex items-center gap-1 bg-white text-red-800 border-2 border-red-800 px-10 py-2 rounded-full group hover:bg-red-800">
                    ...
                    <span class="group-hover:text-white">{{ __('Performance Photos') }}</span>
                </a>
                <a href="#performance-videos" class="inline-flex items-center gap-1 bg-white text-red-800 border-2 border-red-800 px-10 py-2 rounded-full group hover:bg-red-800">
                    ...
                    <span class="group-hover:text-white">{{ __('Performance Videos') }}</span>
                </a>
            </div>
        </div>
    </x-app.hero>
...
<div class="max-w-7xl mx-auto px-4 mt-10">
    <x-app.brush id="performance-photos">
...
<div class="max-w-7xl mx-auto px-4 mt-10">
    <x-app.brush id="performance-videos">
        {{ __('Performance Videos') }}
    </x-app.brush>
</div>
